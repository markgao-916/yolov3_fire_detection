...
if __name__ == '__main__':
    ...
    image = Image.open( '/data/Fire/fire-detection/download1/20190613_006336.jpg')
    box = [104,278,158,323]
    result = distort_image_with_autoaugment(tf.convert_to_tensor(image),tf.convert_to_tensor(box),'test')
    print('==')
